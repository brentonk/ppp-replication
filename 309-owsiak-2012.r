...
data_owsiak_2012 <- read.csv("data-owsiak-2012.csv")
doe_dyad <- read.csv("results/predict-dyad.csv")

## clean spline names
names(data_owsiak_2012)[names(data_owsiak_2012) == "X_spline1"] <- "spline1"
names(data_owsiak_2012)[names(data_owsiak_2012) == "X_spline2"] <- "spline2"
names(data_owsiak_2012)[names(data_owsiak_2012) == "X_spline3"] <- "spline3"
...
save(cr_owsiak_2012,
     doe_owsiak_2012,
     file = "results/replications/owsiak-2012.rda")
